...
{
	AlexLog(@"Conversation became forground: %@", [buddy getName]);
...
{
	AlexLog(@"Conversation lost forground: %@", [buddy getName]);
...
- (void)resizeInputArea
{
	...
	AlexLog(@"Doc Rect: (%f, %f, %f, %f)", doc_box.origin.x, doc_box.origin.y, doc_box.size.width, doc_box.size.height);

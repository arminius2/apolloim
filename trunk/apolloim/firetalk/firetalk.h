...
#define LIBFIRETALK_VERSION "0.1.0-pre23"
...
enum firetalk_callback {
	...
	FC_IM_IDLEINFO,
		/* void *connection, void *clientstruct, char *nickname, char *group, long idletime */
	FC_IM_GOTINFO,
		/* void *connection, void *clientstruct, char *nickname, char *info, int warning, int idle */
	FC_IM_USER_NICKCHANGED,
		/* void *connection, void *clientstruct, char *oldnick, char *newnick, char *group */
	FC_IM_GETMESSAGE,
		/* void *connection, void *clientstruct, char *sender, int automessage_flag, char *message */
	FC_IM_GETACTION,
		/* void *connection, void *clientstruct, char *sender, int automessage_flag, char *message */
	FC_IM_BUDDYONLINE,
		/* void *connection, void *clientstruct, char *nickname, char *group */
	FC_IM_BUDDYOFFLINE,
		/* void *connection, void *clientstruct, char *nickname, char *group */
	FC_IM_BUDDYAWAY,
		/* void *connection, void *clientstruct, char *nickname, char *group */

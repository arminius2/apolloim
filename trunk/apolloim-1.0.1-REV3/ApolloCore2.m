...
+(NSString*)purpleProto:(NSString*)pass
{	
	if([pass isEqualToString:@"ICQ"] || [pass isEqualToString:@"AIM"])
...
- (void)receivedMessage:(NSString*)message withBuddyName:(NSString*)buddy fromAcct:(PurpleAccount*)account 
{
	...
	if(theBuddy == nil)
	{
		...
		NSLog(@"ADDING TEMP BUDDY TO BUDDYLIST: %@", [theBuddy getName]);	
		[self buddyUpdate:theBuddy withCode:BUDDY_LOGIN];

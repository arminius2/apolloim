...
//		NSLog(@"BuddyCell: initializing cell");
		...
		status_onscreen = CGPointMake(10.0, 13.0);
		status_offscreen = CGPointMake(17.0+320, 13.0);
...
-(void) reloadData
{
	...
	if([buddy getMessageCount] <= 0)
		...
		[buddy_label setColor: CGColorCreate(colorSpace, red)];

	[buddy_label setText: [buddy getDisplayName]];
//	[buddy_label setText: [buddy getName]];
//	NSLog(@"BuddyCell.reloadData: name set");
	
	if([buddy isAway])
	{
//		NSLog(@"BuddyCell.reloadData: buddy is away");
	...
	{
//		NSLog(@"BuddyCell.reloadData: buddy is idle");
	...
	{
//		NSLog(@"BuddyCell.reloadData: buddy active and not away");
		[away_image setFrame: CGRectMake(status_offscreen.x,
					status_offscreen.y, 13, 13)];
		[idle_image setFrame: CGRectMake(status_offscreen.x,
					status_offscreen.y, 13, 13)];

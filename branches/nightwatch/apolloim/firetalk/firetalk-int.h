...
struct s_firetalk_protocol_functions {
	...
	enum firetalk_error (*im_add_buddy)(client_t, const char * const, const char * const);
	enum firetalk_error (*im_remove_buddy)(client_t, const char * const, const char * const);
	...
	char * (*translate_open_font)(client_t, const char * const, const char * const, const char * const);
	char * (*translate_open_b)(client_t);
	char * (*translate_open_u)(client_t);
	char * (*translate_open_i)(client_t);
	char * (*translate_open_img)(client_t, const char * const);
	char * (*translate_open_br)(client_t);
	char * (*translate_close_font)(client_t);
	char * (*translate_close_b)(client_t);
	char * (*translate_close_u)(client_t);
	char * (*translate_close_i)(client_t);
